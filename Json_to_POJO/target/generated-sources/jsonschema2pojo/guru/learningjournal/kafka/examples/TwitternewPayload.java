...
public class TwitternewPayload {
    ...
    public String toString() {
        ...
        sb.append(TwitternewPayload.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("createdAt");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TwitternewPayload) == false) {
            return false;
        }
        TwitternewPayload rhs = ((TwitternewPayload) other);
